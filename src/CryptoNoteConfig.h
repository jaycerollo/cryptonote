...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(161803398874989484820);
...
const char     CRYPTONOTE_NAME[]                             = "venomouscoin";
...
const int      P2P_DEFAULT_PORT                              = 45868;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 34365;
